    ...
    <section className="py-20 w-full">
      <div className="grid grid-cols-12 gap-4 xs:gap-6 md:gap-8 w-full">
        ...
        <ItemLayout className={"col-span-full"}>
          <img
            className="w-full h-auto"
            src="https://skillicons.dev/icons?i=js,html,css,react,redux,vite,nextjs,firebase,nodejs,express,mongodb,mysql,c,cpp,python,java,tailwind,discord,git,github,postman,d3,stackoverflow,figma,vscode,windicss,windows,vercel,tensorflow,ros,npm,jquery,linkedin,arduino,linux,threejs,wordpress,"
            alt="Priyanshu"
            loading="lazy"
          />
        </ItemLayout>
